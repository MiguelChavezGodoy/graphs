...
const data = [{ // Mocked Data object for grapsh testing
  date: 'JAN',
  Austin: '72.2',
  Casa: '25'
}, {
...
const getMonth = (d: any) => d.date;
const getAustinTemperature = (d: any) => Number(d.Austin);
const getCasaTemperature = (d: any) => Number(d.Casa);
